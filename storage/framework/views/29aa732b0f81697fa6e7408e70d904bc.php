...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Riwayat Transaksi Hari Ini')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo e($invoice->created_at->format('H:i')); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                            <?php echo e($invoice->patient->name ?? 'N/A'); ?>

                                        </td>
                                        
                                        
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <?php if($invoice->treatment_session_id): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    Sesi Perawatan #<?php echo e($invoice->treatment_session_id); ?>

                                                </span>
                                            <?php elseif($invoice->product_sale_id): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    Penjualan: <?php echo e($invoice->productSale->product_name ?? 'Produk'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\sam\Documents\File_Coding\HTML, CSS, JAVASCRIPT dan GAMBAR\Kuliah\projek\KaryaSuci\resources\views/cashier/history/index.blade.php ENDPATH**/ ?>